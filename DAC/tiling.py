...
def tile(n, x, y):
    ...
    if (r < x + n / 2 and c < y + n / 2):
        place(x + int(n / 2), y + int(n / 2) - 1, x + int(n / 2),
              y + int(n / 2), x + int(n / 2) - 1, y + int(n / 2))

    elif(r >= x + int(n / 2) and c < y + int(n / 2)):
        place(x + int(n / 2) - 1, y + int(n / 2), x + int(n / 2),
              y + int(n / 2), x + int(n / 2) - 1, y + int(n / 2) - 1)
        ...
        place(x + int(n / 2) - 1, y + int(n / 2), x + int(n / 2), y +
              int(n / 2) - 1, x + int(n / 2) - 1, y + int(n / 2) - 1)
